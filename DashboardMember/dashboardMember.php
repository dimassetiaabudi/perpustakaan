...
<body>
            ...
            <ul style="margin-left: -7rem" class="dropdown-menu position-absolute mt-2 p-2">
               ...
               <li>
                  <a class="dropdown-item text-center text-secondary" href="#">
                     <span class="text-capitalize"><?php echo $_SESSION['member']['nama']; ?></span></a>
   ...
   <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">
         ...
         <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?>
         </span>
         di Dashboard smartbook
      </div>
         ...
         <div class="d-flex flex-wrap justify-content-center gap-2">
            <div class="cardImg">
               <a href="buku/daftarBuku.php">
                  <img src="../assets/dashboardCardMember/daftarBuku.png" alt="daftar buku" style="max-width: 100%"
                     width="600px" />
               </a>
            </div>
            <div class="cardImg">
            ...
            <div class="cardImg">
               <a href="formPeminjaman/TransaksiPengembalian.php">
                  <img src="../assets/dashboardCardMember/HISTORY.png" alt="daftar buku" style="max-width: 100%"
                     width="600px" />
               </a>
            </div>
         </div>
