         ...
         <form action="" method="post" class="row g-3 p-4 needs-validation" novalidate>
            ...
            <div class="input-group mb-2">
               ...
               <select class="form-select" id="inputGroupSelect01" name="jurusan">
                  ...
                  <option value="Desain Pemodelan Informasi Bangunan">
                  ...
                  <option value="Sistem Informatika Jaringan dan Aplikasi">
            ...
            <p>
               ...
               <a href="sign_in.php" class="text-decoration-none text-primary">Sign In</a>
            </p>
         </form>
      </div>
   </div>
